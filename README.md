...
*A utility application that dynamically converts user-input data, text, or URLs into high-quality, scannable QR codes.*
- **Tech Stack:** Java (or Python/JavaScript), QR Code Libraries (e.g., ZXing / qrcode), File I/O, HTML/CSS
- **Key Features:**
  - **Dynamic Generation:** Implemented core encoding algorithms to process strings, URLs, and text payloads into matrices mapping to standard QR code formats.
